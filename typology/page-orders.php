            	...
            	<article id="post-<?php the_ID(); ?>" <?php post_class( 'typology-post typology-single-post' ); ?>>
            		...
            		<?php if(!absint($meta['cover']) ) : ?>
            		    <header class="entry-header">
            		        <?php the_title( '<h2 class="entry-title entry-title-cover-empty">', '</h2>' ); ?>
            		    </header>
            		<?php endif; ?>
            	    <div class="entry-content clearfix">
                        ...
                        <?php
                            ...
                            <div class="order" post_id="<? the_ID() ?>">
                                <a href="/order/<? the_ID()?>"><? the_title() ?></a><a href="#" class="take_on_work">Взять в работу</a>
                            </div> 
                            <?php
            	    ...
            	    <div class="entry-content clearfix">
                        ...
                        <?php
                            while(have_posts()) :
                                ...
                                ?>
                            <div class="order">
                                <a href="/order/<? the_ID()?>"><? the_title() ?></a>
                            </div>
                            <?php
                            endwhile; wp_reset_query();?>
                        </div>
            	    ...
            	    <div class="entry-content clearfix">
                        ...
                        <?php
                           ...
                           <div class="order">
                                <div>
                                    <a href="/order/<? the_ID()?>"><? the_title() ?></a>
                                    <a href="/order/<? the_ID()?>?download_doc"> (скачать)</a>
                                </div>
                            </div>
                            <?php
                            endwhile; wp_reset_query();?>
